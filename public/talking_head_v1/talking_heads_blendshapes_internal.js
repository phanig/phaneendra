...
var ModuleFactory = (() => {
  ...
  return function (ModuleFactory) {
    ...
    var ASM_CONSTS = {
      612691: ($0) => {
        if (typeof Module.EM_DRISHTI_DYN_CALCULATORS === "undefined") {
          console.log(
            "Creating dynamic JS calculator lookup table in contract."
          );
        ...
        Module.EM_DRISHTI_DYN_CALCULATORS[$0].setProcess = function (
          processFcn
        ) {
      ...
      613525: ($0, $1) => {
        ...
        if (typeof Module.EM_DRISHTI_DYN_FUNC_TABLE[$0] !== "undefined") {
          console.log(
            "Error: duplicate dynamic JS calculator at address: ",
            $0
          );
        }
        if (typeof Module.EM_DRISHTI_DYN_CALCULATORS === "undefined") {
        ...
        Module.EM_DRISHTI_DYN_FUNC_TABLE[$0].push(
          makeAutoDeleting(__em_drishti_true_func)
        );
        const newProcessFcn = function (userProcessFcn) {
          ...
          newContext["routeAnyInputToOutputStream"] = function (
            inStreamId,
            outStreamId
          ) {
          ...
          newContext["getProtoBytesFromStream"] = function (streamId) {
            const dataPtr = Module.__createProtoDataPointerFromStream(
              $0,
              streamId
            );
            const dataSize = Module.__getProtoSizeFromProtoDataPointer(dataPtr);
            const dataBytesPtr =
              Module.__getProtoBytesFromProtoDataPointer(dataPtr);
            const newProtoArray = Module.HEAPU8.slice(
              dataBytesPtr,
              dataBytesPtr + dataSize
            );
            Module.__freeProtoDataPointer(dataPtr);
            return newProtoArray;
          };
          newContext["addProtoBytesToStream"] = function (
            uint8Array,
            protoType,
            streamId
          ) {
        ...
        Module.EM_DRISHTI_DYN_CALCULATORS[$1].setClose = function (
          newCloseFcn
        ) {
          Module.EM_DRISHTI_DYN_FUNC_TABLE[$0][2] =
            makeAutoDeleting(newCloseFcn);
        };
        if (typeof Module.EM_DRISHTI_DYN_FUNC_CACHE !== "undefined") {
          if (typeof Module.EM_DRISHTI_DYN_FUNC_CACHE[$1] !== "undefined") {
            if (typeof Module.EM_DRISHTI_DYN_FUNC_CACHE[$1][0] === "function") {
              Module.EM_DRISHTI_DYN_CALCULATORS[$1].setOpen(
                Module.EM_DRISHTI_DYN_FUNC_CACHE[$1][0]
              );
            }
            if (typeof Module.EM_DRISHTI_DYN_FUNC_CACHE[$1][1] === "function") {
              Module.EM_DRISHTI_DYN_CALCULATORS[$1].setProcess(
                Module.EM_DRISHTI_DYN_FUNC_CACHE[$1][1]
              );
            }
            if (typeof Module.EM_DRISHTI_DYN_FUNC_CACHE[$1][2] === "function") {
              Module.EM_DRISHTI_DYN_CALCULATORS[$1].setClose(
                Module.EM_DRISHTI_DYN_FUNC_CACHE[$1][2]
              );
            }
    ...
    var _configureAudio = (Module["_configureAudio"] = function () {
      return (_configureAudio = Module["_configureAudio"] =
        Module["asm"]["Cb"]).apply(null, arguments);
    });

    var _addAudioToInputStream = (Module["_addAudioToInputStream"] =
      function () {
        return (_addAudioToInputStream = Module["_addAudioToInputStream"] =
          Module["asm"]["Db"]).apply(null, arguments);
      });

    var _free = (Module["_free"] = function () {
      return (_free = Module["_free"] = Module["asm"]["Eb"]).apply(
        null,
        arguments
      );
    });
    ...
    var _malloc = (Module["_malloc"] = function () {
      return (_malloc = Module["_malloc"] = Module["asm"]["Fb"]).apply(
        null,
        arguments
      );
    });
    ...
    var _processGl = (Module["_processGl"] = function () {
      return (_processGl = Module["_processGl"] = Module["asm"]["mc"]).apply(
        null,
        arguments
      );
    });
    ...
    var _process = (Module["_process"] = function () {
      return (_process = Module["_process"] = Module["asm"]["nc"]).apply(
        null,
        arguments
      );
    });
    ...
    var _isEmptyStream = (Module["_isEmptyStream"] = function () {
      return (_isEmptyStream = Module["_isEmptyStream"] =
        Module["asm"]["sc"]).apply(null, arguments);
    });

    var _routeAnyInputToOutputStream = (Module["_routeAnyInputToOutputStream"] =
      function () {
        return (_routeAnyInputToOutputStream = Module[
          "_routeAnyInputToOutputStream"
        ] =
          Module["asm"]["tc"]).apply(null, arguments);
      });

    var _addFloatToStream = (Module["_addFloatToStream"] = function () {
      return (_addFloatToStream = Module["_addFloatToStream"] =
        Module["asm"]["uc"]).apply(null, arguments);
    });

    var _addIntToStream = (Module["_addIntToStream"] = function () {
      return (_addIntToStream = Module["_addIntToStream"] =
        Module["asm"]["vc"]).apply(null, arguments);
    });

    var _addStringToStream = (Module["_addStringToStream"] = function () {
      return (_addStringToStream = Module["_addStringToStream"] =
        Module["asm"]["wc"]).apply(null, arguments);
    });

    var __createTempFloatVec = (Module["__createTempFloatVec"] = function () {
      return (__createTempFloatVec = Module["__createTempFloatVec"] =
        Module["asm"]["xc"]).apply(null, arguments);
    });

    var __createTempUint8Vec = (Module["__createTempUint8Vec"] = function () {
      return (__createTempUint8Vec = Module["__createTempUint8Vec"] =
        Module["asm"]["yc"]).apply(null, arguments);
    });

    var __tempFloatVecPush = (Module["__tempFloatVecPush"] = function () {
      return (__tempFloatVecPush = Module["__tempFloatVecPush"] =
        Module["asm"]["zc"]).apply(null, arguments);
    });

    var __tempUint8VecPush = (Module["__tempUint8VecPush"] = function () {
      return (__tempUint8VecPush = Module["__tempUint8VecPush"] =
        Module["asm"]["Ac"]).apply(null, arguments);
    });

    var _addFloatVecToStream = (Module["_addFloatVecToStream"] = function () {
      return (_addFloatVecToStream = Module["_addFloatVecToStream"] =
        Module["asm"]["Bc"]).apply(null, arguments);
    });

    var _addProtoBytesToStream = (Module["_addProtoBytesToStream"] =
      function () {
        return (_addProtoBytesToStream = Module["_addProtoBytesToStream"] =
          Module["asm"]["Cc"]).apply(null, arguments);
      });

    var _getNumberFromStream = (Module["_getNumberFromStream"] = function () {
      return (_getNumberFromStream = Module["_getNumberFromStream"] =
        Module["asm"]["Dc"]).apply(null, arguments);
    });

    var __createProtoDataPointerFromStream = (Module[
      "__createProtoDataPointerFromStream"
    ] = function () {
      return (__createProtoDataPointerFromStream = Module[
        "__createProtoDataPointerFromStream"
      ] =
        Module["asm"]["Ec"]).apply(null, arguments);
    });

    var __getProtoSizeFromProtoDataPointer = (Module[
      "__getProtoSizeFromProtoDataPointer"
    ] = function () {
      return (__getProtoSizeFromProtoDataPointer = Module[
        "__getProtoSizeFromProtoDataPointer"
      ] =
        Module["asm"]["Fc"]).apply(null, arguments);
    });

    var __getProtoBytesFromProtoDataPointer = (Module[
      "__getProtoBytesFromProtoDataPointer"
    ] = function () {
      return (__getProtoBytesFromProtoDataPointer = Module[
        "__getProtoBytesFromProtoDataPointer"
      ] =
        Module["asm"]["Gc"]).apply(null, arguments);
    });

    var __freeProtoDataPointer = (Module["__freeProtoDataPointer"] =
      function () {
        return (__freeProtoDataPointer = Module["__freeProtoDataPointer"] =
          Module["asm"]["Hc"]).apply(null, arguments);
      });

    var _getInputTimestamp = (Module["_getInputTimestamp"] = function () {
      return (_getInputTimestamp = Module["_getInputTimestamp"] =
        Module["asm"]["Ic"]).apply(null, arguments);
    });
    ...
    var _setThrew = (Module["_setThrew"] = function () {
      return (_setThrew = Module["_setThrew"] = Module["asm"]["Lc"]).apply(
        null,
        arguments
      );
    });
    ...
    var stackSave = (Module["stackSave"] = function () {
      return (stackSave = Module["stackSave"] = Module["asm"]["Mc"]).apply(
        null,
        arguments
      );
    });
    ...
    var stackAlloc = (Module["stackAlloc"] = function () {
      return (stackAlloc = Module["stackAlloc"] = Module["asm"]["Oc"]).apply(
        null,
        arguments
      );
    });
