    ...
    <group {...props} dispose={null}>
      <group rotation={[1.51, 0, 0]} scale={0.28}>
        ...
        <mesh
          ...
          material={materials.GLASSES_SHD}
        ...
        <mesh
          ...
          material={materials.eyelash_SHD}
